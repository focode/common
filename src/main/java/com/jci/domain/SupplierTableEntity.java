...
public class SupplierTableEntity extends TableServiceEntity {
	...
	public String toString() {
		return "SupplierTableEntity [ SupplierID=" + SupplierID + ",SupplierJsonString=" + SupplierJsonString + ""
				+ ",erp=" + erp + ", region=" + region + "" + ",plant=" + plant + ",supplierProcessingStatus="
				+ supplierProcessingStatus + "" + ",supplierProcessingStatusCode=" + supplierProcessingStatusCode
				+ ",supplierProcessingStatusmesssage=" + supplierProcessingStatusmesssage + "" + ",supplierType="
				+ supplierType + ",supplierDeliveryState=" + supplierDeliveryState + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SupplierTableEntity other = (SupplierTableEntity) obj;
